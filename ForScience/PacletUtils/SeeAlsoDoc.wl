...
Details[SeeAlso]={
  "[*SeeAlso*] is one of the metadata symbols used by [*DocumentationBuilder*]. Others include [*Usage*], [*Details*] and [*Examples*].",
...
SeeAlso[SeeAlso]={DocumentationBuilder,Usage,Details,Examples};
