...
AtomPositions[Molecule[atoms_,__]]:=MapAt[Reap[ApplyToWrapped[Sow,#,_List]][[2,1,1]]&,atoms,{All,2}]

NormalVector[mol_Molecule]:=Let[
  {
    pos=mol["PositionList"],
    com=Mean@pos,
    relPos=#-com&/@pos
  },
  First@Last@Eigensystem[Total[IdentityMatrix[3]#.#-Outer[Times,#,#]&/@relPos],1]/;
  Dimensions[pos][[2]]==3
]
...
$MoleculeElements={
  ...
  "PositionList"->(#["AtomPositions"][[All,2]]&)
};

_Molecule["Elements"]:=$MoleculeElements[[All,1]]
mol_Molecule[el:Except["Except"]]/;MemberQ[mol["Elements"],el]:=(el/.$MoleculeElements)[mol]
